...
trim-cli monitor net
trim-cli monitor disk
trim-cli monitor gen --item storeSpeed,netSpeed --item cpuBusy
trim-cli monitor proc-list
trim-cli monitor proc-info --pids 123,456
trim-cli monitor proc-srv
trim-cli monitor sys-warn
trim-cli monitor battery
trim-cli monitor sys-fan
trim-cli monitor beep-supported
trim-cli monitor beep-events
trim-cli monitor beep-reasons
trim-cli monitor mute-beeper
trim-cli monitor request appcgi.resmon.gen --json '{"item":["cpuBusy"]}'
```
