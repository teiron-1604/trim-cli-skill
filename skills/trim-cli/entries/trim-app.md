...
trim-cli --host <host> --port <port> app status <appName>
trim-cli --host <host> --port <port> app entry list
trim-cli --host <host> --port <port> app desktop list
trim-cli --host <host> --port <port> app sac app-store-list
trim-cli --host <host> --port <port> app install <appName> --version <version> --source-id <sourceID> --volume-id <volumeId> --dry-run --yes
trim-cli --host <host> --port <port> app install <appName> --version <version> --source-id <sourceID> --volume-id <volumeId> --yes
trim-cli --host <host> --port <port> app install <appName> --version <version> --custom-parameters '[{"key":"port","value":8080}]' --api-scope '{"API.User.FileAccess":true}' --volume-id <volumeId> --yes
trim-cli --host <host> --port <port> app install <appName> --version <version> --volume-id <volumeId> --accept-license --cancel-on-failure --yes
trim-cli --host <host> --port <port> app install-fpk <localFile.fpk> --volume-id <volumeId> --dry-run --yes
trim-cli --host <host> --port <port> app install-fpk <localFile.fpk> --volume-id <volumeId> --yes
trim-cli --host <host> --port <port> app install-fpk --remote-path /vol1/1000/demo.fpk --volume-id <volumeId> --dry-run --yes
trim-cli --host <host> --port <port> app update <appName> --version <version> --volume-id <volumeId> --dry-run --yes
trim-cli --host <host> --port <port> app update <appName> --version <version> --volume-id <volumeId> --yes
trim-cli --host <host> --port <port> app openapi add-user-auth-path <appName> /vol1/1000/docs --yes
trim-cli --host <host> --port <port> app start <appName> --yes
trim-cli --host <host> --port <port> app stop <appName> --yes
trim-cli --host <host> --port <port> app uninstall <appName> --yes
```
