...
trim-cli download ls installer
trim-cli download info <id>
trim-cli download files <id>
trim-cli download add-uri https://example.com/file.iso /vol1/download --yes
trim-cli download add-path /vol1/source.torrent /vol1/download --yes
...
trim-cli download request appcgi.downloadcenter.tracker.query --json '{}' --yes
```
