...
```bash
trim-cli file ls
trim-cli file ls /vol1/downloads
trim-cli file search <key>
trim-cli file upload /vol1/1000/uploads ./local-file.txt --overwrite rename --yes
trim-cli file share list
trim-cli file acl get /vol1/1000/docs
```
