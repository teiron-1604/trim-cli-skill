...
trim-cli baidu-netdisk ls / --limit 80
trim-cli baidu-netdisk search <keyword> --dir / --recursive
trim-cli baidu-netdisk info <fsid...>
trim-cli baidu-netdisk mkdir /备份 --yes
trim-cli baidu-netdisk upload /备份 /vol1/1000/data --yes
trim-cli baidu-netdisk download /vol1/1000/downloads <fsid...> --yes
trim-cli baidu-netdisk share-save '<shareUrlWithPassword>' /vol1/1000/downloads --all --yes
trim-cli baidu-netdisk task list --transfer download
