...
| 查看百度网盘授权、浏览文件、保存分享链接、管理传输或同步任务 | [baidu-netdisk.md](baidu-netdisk.md) | 百度账号授权必须在 NAS 应用页面完成；所有写操作需要 `--yes` |
...
| [../entries/trim-baidu-netdisk.md](../entries/trim-baidu-netdisk.md) | 百度网盘授权状态、空间、文件操作、分享链接保存、NAS 传输和同步任务 |
...
| baidu-netdisk | [baidu-netdisk.md](baidu-netdisk.md) | 百度网盘授权、文件、分享链接保存、传输任务和同步任务 |
