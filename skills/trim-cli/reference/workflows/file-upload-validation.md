...
```bash
trim-cli file upload /vol1/1000/tmp-upload ./demo.txt --overwrite rename --yes
```

3. 列出临时目录：

```bash
trim-cli file ls /vol1/1000/tmp-upload
```
...
```bash
trim-cli file upload /vol1/1000/tmp-upload ./large.bin --overwrite rename --yes
```
...
```bash
trim-cli file rm /vol1/1000/tmp-upload/demo.txt --yes
trim-cli file rm /vol1/1000/tmp-upload --yes
```
